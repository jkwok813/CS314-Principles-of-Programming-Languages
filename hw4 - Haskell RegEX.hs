...
firsts REps = []
firsts (RSym s) = [s]
firsts (RSeq REps b) = firsts b
firsts (RSeq (RStar a) b) = firsts a ++ firsts b
firsts (RAlt a b) = firsts a ++ firsts b
firsts (RSeq a b) = firsts a
